...
class CryptoCurrencyCard extends Widget_Base {
	...
	public function get_icon() {
		return 'bdt-wi-cryptocurrency-card';
	}
			...
			<div bdt-grid>
				...
				<div class="bdt-width-1-1 bdt-margin-small-top bdt-ccc-atributes">
					...
					<div class="bdt-ccc-atribute">
						...
						<span>#<?php echo $coin['market_cap_rank']; ?></span>
						<?php endif; ?>
					</div>
					...
					<div class="bdt-ccc-atribute">
						...
						<span><?php echo esc_html( $currency_symbol ); ?><?php echo $coin['market_cap']; ?></span>
						<?php endif; ?>
					</div>
					...
					<div class="bdt-ccc-atribute">
						...
						<span><?php echo esc_html( $currency_symbol ); ?><?php echo $coin['total_volume']; ?></span>
						<?php endif; ?>
					</div>
					...
					<div class="bdt-ccc-atribute">
						...
						<span><?php echo esc_html( $currency_symbol ); ?><?php echo $coin['high_24h']; ?>/<?php echo esc_html( $currency_symbol ); ?><?php echo $coin['low_24h']; ?></span>
						<?php endif; ?>
					</div>
