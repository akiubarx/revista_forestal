		...
		<div <?php echo $this->get_render_attribute_string('dropdown-settings'); ?>>
		    ...
		    <ul class="bdt-nav bdt-dropdown-nav">
		    	<?php if ( $settings['show_edit_profile'] ) : ?>
			        <li><a href="<?php echo get_edit_user_link(); ?>"><span class="bdt-ul-custom-nav-icon"><i class="far fa-edit fa-fw"></i></span> <?php esc_html_e( 'Edit Profile', 'bdthemes-element-pack' ); ?></a></li>
			    <?php endif; ?>
		        ...
		        <li><a href="<?php echo wp_logout_url( $current_url ); ?>" class="bdt-ul-logout-menu"><span class="bdt-ul-custom-nav-icon"><i class="fas fa-lock fa-fw"></i></span> <?php esc_html_e( 'Logout', 'bdthemes-element-pack' ); ?></a></li>
		    </ul>
		</div>
