...
*/
    ...
    function pageloader_theme_customizer( $wp_customize ) {
        ...
        $wp_customize->add_setting( 'bonfire_pageloader_background_color_secondary', array( 'sanitize_callback' => 'sanitize_hex_color' ));
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'bonfire_pageloader_background_color_secondary',array(
            'label' => 'Background color (secondary)', 'description' => 'When secondary color chosen, background will fade between the two colors.', 'settings' => 'bonfire_pageloader_background_color_secondary', 'section' => 'pageloader_background_section' )
        ));

        /* background color fade speed */
        $wp_customize->add_setting('bonfire_pageloader_background_color_fade_speed',array('sanitize_callback' => 'sanitize_bonfire_pageloader_background_color_fade_speed',));
        function sanitize_bonfire_pageloader_background_color_fade_speed($input) {return wp_kses_post(force_balance_tags($input));}
        $wp_customize->add_control('bonfire_pageloader_background_color_fade_speed',array(
            'type' => 'text',
    ...
    <?php if (!isset($_SESSION['pageloader_session_customizer'])) { $_SESSION['pageloader_session_customizer'] = '0'; ?>
		...
		.bonfire-pageloader-background {
            background-color:<?php echo get_theme_mod('bonfire_pageloader_background_color'); ?>;
            opacity:<?php echo get_theme_mod('bonfire_pageloader_background_opacity'); ?>;
        }

        /* secondary background color + fade between background colors */
        <?php if( get_theme_mod('bonfire_pageloader_background_color_secondary') != '') { ?>
            .bonfire-pageloader-background {
                animation:plbganimation <?php if( get_theme_mod('bonfire_pageloader_background_color_fade_speed') != '') { ?><?php echo get_theme_mod('bonfire_pageloader_background_color_fade_speed'); ?><?php } else { ?>3<?php } ?>s infinite;
                -moz-animation:plbganimation <?php if( get_theme_mod('bonfire_pageloader_background_color_fade_speed') != '') { ?><?php echo get_theme_mod('bonfire_pageloader_background_color_fade_speed'); ?><?php } else { ?>3<?php } ?>s infinite;
                -webkit-animation:plbganimation <?php if( get_theme_mod('bonfire_pageloader_background_color_fade_speed') != '') { ?><?php echo get_theme_mod('bonfire_pageloader_background_color_fade_speed'); ?><?php } else { ?>3<?php } ?>s infinite;
            }
            @-moz-keyframes plbganimation {
                0% {background:<?php if( get_theme_mod('bonfire_pageloader_background_color') != '') { ?><?php echo get_theme_mod('bonfire_pageloader_background_color'); ?><?php } else { ?>#1FB6DB<?php } ?>;}
                50% {background:<?php echo get_theme_mod('bonfire_pageloader_background_color_secondary'); ?>;}
                100% {background:<?php if( get_theme_mod('bonfire_pageloader_background_color') != '') { ?><?php echo get_theme_mod('bonfire_pageloader_background_color'); ?><?php } else { ?>#1FB6DB<?php } ?>;}
            }
