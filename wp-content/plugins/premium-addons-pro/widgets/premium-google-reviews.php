...
//        }
        ...
        <div class="premium-fb-rev-container google-reviews <?php echo 'premium-reviews-'. $settings['reviews_style']; ?>" data-col="<?php echo esc_attr( $reviews_number ); ?>" data-style="<?php echo esc_attr($settings['reviews_style']); ?>" data-carousel="<?php echo $carousel; ?>" data-play="<?php echo $play; ?>" data-speed="<?php echo $speed; ?>" data-rtl="<?php echo $rtl; ?>">
