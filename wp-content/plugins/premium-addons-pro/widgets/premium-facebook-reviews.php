...
//            $this->add_render_attribute( 'page', 'class', $settings['page_dir'] );
//        }
        
        $this->add_render_attribute( 'reviews', 'class', 'premium-fb-rev-content' );
        
//        if( 'inline' == $settings['reviews_display'] ) {
//            $this->add_render_attribute( 'reviews_dir', 'class', $settings['reviews_dir'] );
//        }
        ...
        } elseif ( ! isset( $response_json->data[0]->reviewer ) ) {
        ...
        <div class="premium-fb-rev-container facebook-reviews <?php echo 'premium-reviews-'. $settings['reviews_style']; ?>" data-col="<?php echo esc_attr( $reviews_number ); ?>" data-style="<?php echo esc_attr($settings['reviews_style']); ?>" data-carousel="<?php echo $carousel; ?>" data-play="<?php echo $play; ?>" data-speed="<?php echo $speed; ?>" data-rtl="<?php echo $rtl; ?>">
