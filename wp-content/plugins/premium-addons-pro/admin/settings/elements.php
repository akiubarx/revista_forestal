...
class Premium_Pro_Admin_Settings {
    ...
    public static $pa_pro_elements_keys = ['premium-iconbox', 'premium-twitter-feed', 'premium-instagram-feed', 'premium-notbar', 'premium-flipbox', 'premium-unfold', 'premium-fb-chat', 'premium-whatsapp-chat', 'premium-tabs', 'premium-charts', 'premium-prev-img', 'premium-image-hotspots', 'premium-image-comparison', 'premium-facebook-reviews', 'premium-facebook-feed', 'premium-magic-section', 'premium-google-reviews', 'premium-behance', 'premium-img-layers', 'premium-ihover', 'premium-content-toggle', 'premium-tables', 'premium-divider', 'premium-multi-scroll', 'premium-image-accordion', 'premium-yelp-reviews', 'premium-parallax', 'premium-particles', 'premium-gradient', 'premium-kenburns', 'premium-badge'];
