            ...
            var l = {
                ...
                facebook: {
                    ...
                    getData: function(t) {
                        ...
                        var e = function(t) {
                                s.request(t, l.facebook.utility.savePosts)
                            },
                        ...
                        savePosts: function(e) {
                            ...
                            if (e.error) {
                                t.ajax({
                                    ...
                                    dataType: "json",
                                    data: {
                                        action: "get_pa_option",
                                        key: "id-" + i.facebook.accounts[0]
                                    },
                                    success: function(res) {
                                        l.facebook.utility.getPosts(res.data.posts);
                                    },
                                    error: function(err) {
                                        console.log(err);
                                    }
                                ...
                                t.ajax({
                                    ...
                                    dataType: "text",
                                    data: {
                                        action: "update_pa_option",
                                        key: "id-" + i.facebook.accounts[0],
                                        value: e
                                    },
                                    success: function(res) {
                                        l.facebook.utility.getPosts(e);
                                    },
                                    error: function(err){
                                        console.log(err);
                                    }
